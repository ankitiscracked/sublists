#!/usr/bin/env python3
"""Install Sublists' companion and register its fixed extension ID. No sudo."""
import argparse
import base64
import hashlib
import json
...
if sys.platform != "darwin":
    parser.error("Apple Notes companion requires macOS.")
...
print(f"Companion installed for extension {extension_id}.")
